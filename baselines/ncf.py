...
Original file is located at
    https://colab.research.google.com/drive/1y4ri7fZbMLVKV4AOK4i1pMjL78r2NfSI
"""
...
import dill
config = {"seed":42,"lr":1e-3,"dropout":0.2,"batch_size":256,"epochs":30,"factor_num":8,"layers":[64,32,16,8],"num_users":40163,"num_items":139738,"latent_dim_mf":8,"latent_dim_mlp":8}
model = NeuMF(config)
model = model.cuda()
...
for epoch in range(200):
  ...
  if(breakout==10):
    break
  #if(epoch%10==0):
      #file = "/content/drive/MyDrive/Copy of Epinions/Ciao/Models/NCF_"+str(epoch)+"_"+str(1e-3)
